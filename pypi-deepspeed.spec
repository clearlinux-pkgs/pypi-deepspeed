...
Version  : 0.12.3
Release  : 18
URL      : https://files.pythonhosted.org/packages/61/e6/04e2f2de08253e6b779fe7706f2e06d8fb48353e1d33a2fd7805062213d4/deepspeed-0.12.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/61/e6/04e2f2de08253e6b779fe7706f2e06d8fb48353e1d33a2fd7805062213d4/deepspeed-0.12.3.tar.gz
...
%prep
%setup -q -n deepspeed-0.12.3
cd %{_builddir}/deepspeed-0.12.3
pushd ..
cp -a deepspeed-0.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701157042
