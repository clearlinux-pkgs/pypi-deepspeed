...
Version  : 0.16.5
Release  : 48
URL      : https://files.pythonhosted.org/packages/0d/88/96569b2acb3219c9c72068f9b952c59beffe366e7d1edd9e922e5c68f08b/deepspeed-0.16.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/0d/88/96569b2acb3219c9c72068f9b952c59beffe366e7d1edd9e922e5c68f08b/deepspeed-0.16.5.tar.gz
...
%prep
%setup -q -n deepspeed-0.16.5
cd %{_builddir}/deepspeed-0.16.5
pushd ..
cp -a deepspeed-0.16.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743172526
