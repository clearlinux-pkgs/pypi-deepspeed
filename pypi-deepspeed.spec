...
Version  : 0.15.4
Release  : 42
URL      : https://files.pythonhosted.org/packages/34/c5/dfa824defc1919289a00cbb722aee92cee85ce1e11f7349779235dbe4810/deepspeed-0.15.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/34/c5/dfa824defc1919289a00cbb722aee92cee85ce1e11f7349779235dbe4810/deepspeed-0.15.4.tar.gz
...
%prep
%setup -q -n deepspeed-0.15.4
cd %{_builddir}/deepspeed-0.15.4
pushd ..
cp -a deepspeed-0.15.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731095451
